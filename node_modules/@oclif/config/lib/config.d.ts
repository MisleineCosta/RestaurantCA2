...
import { Hooks } from '@oclif/config/lib/hooks';
import { PJSON } from '@oclif/config/lib/pjson';
import * as Plugin from '@oclif/config/lib/plugin';
import { Topic } from '@oclif/config/lib/topic';
